package com.hd.micromonitorservice.conf.operlog;
...
public class OperLogAspect {
     ...
     */
    @Pointcut("execution(* com.hd.micromonitorservice.controller..*.*(..))")
    ...
    public void saveOperLog(JoinPoint joinPoint, Object keys) {
        ...
        try {
            ...
            {
                wrapper= (RepeatedlyReadRequestWrapper) request;   //new RepeatedlyReadRequestWrapper((HttpServletRequest) request);
                params = new String(wrapper.getBody()) ;
            }
            else {
            ...
            String logMsg =  String.format("\n操作模块:%s,操作类型:%s,操作描述:%s\n请求ip:%s,请求URI:%s,请求账号:%s\n请求方法:%s,请求参数:%s,返回结果:%s\n",
                    operModul,operType,operDesc
