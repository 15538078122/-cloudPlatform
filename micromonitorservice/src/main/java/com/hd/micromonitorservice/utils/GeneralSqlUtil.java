...
import com.hd.micromonitorservice.conf.GeneralSqlConfig;
...
public class GeneralSqlUtil {
    ...
    private static GlobalConfig globalConfig() {
        return new GlobalConfig()
                .setAuthor(GeneralSqlConfig.AUTHOR)
                .setOutputDir(GeneralSqlConfig.OUTPUT_DIR)
                ...
                .setEntityName(GeneralSqlConfig.FILE_NAME_MODEL)
                .setMapperName(GeneralSqlConfig.FILE_NAME_DAO)
                .setXmlName(GeneralSqlConfig.FILE_NAME_XML)
                .setServiceName(GeneralSqlConfig.FILE_NAME_SERVICE)
                .setServiceImplName(GeneralSqlConfig.FILE_NAME_SERVICE_IMPL)
                .setControllerName(GeneralSqlConfig.FILE_NAME_CONTROLLER)
                .setIdType(IdType.ASSIGN_ID) // 主键类型
                .setSwagger2(GeneralSqlConfig.SWAGGER_SUPPORT) // model swagger2
                ;
...
//                    config.setServiceName("%sService");
    ...
    private static StrategyConfig strategyConfig(String [] tablePrefixes, String [] tableNames, String [] fieldPrefixes) {
        return new StrategyConfig()
                ...
                .setLogicDeleteFieldName(GeneralSqlConfig.FIELD_LOGIC_DELETE_NAME) // 逻辑删除属性名称
                .setVersionFieldName(GeneralSqlConfig.FIELD_VERSION_NAME) // 乐观锁字段名
    ...
    private static PackageConfig packageConfig(String packageName) {
        return new PackageConfig()
                ...
                .setController(GeneralSqlConfig.PACKAGE_NAME_CONTROLLER)
                .setEntity(GeneralSqlConfig.PACKAGE_NAME_MODEL)
                .setMapper(GeneralSqlConfig.PACKAGE_NAME_DAO)
                .setXml(GeneralSqlConfig.DIR_NAME_XML)
                .setService(GeneralSqlConfig.PACKAGE_NAME_SERVICE)
                .setServiceImpl(GeneralSqlConfig.PACKAGE_NAME_SERVICE_IMPL)
                ;
    }
        ...
        fileOutConfigList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                if (StringUtils.isEmpty(packageConfig.getModuleName())) {
                    return GeneralSqlConfig.PROJECT_PATH + "/src/main/resources/mapper/" + tableInfo.getXmlName() + StringPool.DOT_XML;
                }else {
                    return GeneralSqlConfig.PROJECT_PATH + "/src/main/resources/mapper/" + packageConfig.getModuleName() + "/" + tableInfo.getXmlName() + StringPool.DOT_XML;
                }
            }
        });
    ...
    private static AbstractTemplateEngine getTemplateEngine() {
        String templateEngine = GeneralSqlConfig.TEMPLATE_ENGINE;
