...
public class JwtUtils {
    ...
    private  String publicKeyManufacturer = null;
    public   RSAPublicKey rsaPublicKey  ;
    public   RSAPublicKey rsaPublicKeyForManufacturer  ;

    @PostConstruct
    public  void  init(){
        Resource resource = new ClassPathResource("public.txt");
        Resource resourceManufacturer = new ClassPathResource("publicManufacturer.txt");
        try {
            publicKey = inputStream2String(resource.getInputStream());
            publicKeyManufacturer = inputStream2String(resourceManufacturer.getInputStream());
        ...
        rsaPublicKeyForManufacturer = RsaKeyHelper.parsePublicKey(publicKeyManufacturer.trim());
    }
