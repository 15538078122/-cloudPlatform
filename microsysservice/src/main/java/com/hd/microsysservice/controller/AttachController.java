...
public class AttachController extends SuperQueryController {
    ...
    public RetResult attachUploadOne(HttpServletRequest request, HttpServletResponse response, MultipartFile file) {
        try {
                SyAttachVo syAttachVo=new SyAttachVo();
    ...
    public RetResult attachMerge(String guid, Integer chunks,String fileName) {
        try {
            SyAttachVo syAttachVo=new SyAttachVo();
            syAttachVo.setFileName(fileName);
